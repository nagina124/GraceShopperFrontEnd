      ...
      <Carousel className="carousel">
        ...
        <Carousel.Item style={{ height: "50vh", overflow: "hidden" }}>
          ...
          <Carousel.Caption>
            ...
            <p>
              Immerse yourself in the city of Midgar like never before, with
        ...
        <Carousel.Item style={{ height: "50vh", overflow: "hidden" }}>
          ...
          <Carousel.Caption>
            ...
            <p>
              Experience survival horror like never before in Resident Evil
              Village.
            </p>
          </Carousel.Caption>
        </Carousel.Item>
        ...
        <Carousel.Item style={{ height: "50vh", overflow: "hidden" }}>
          <img
            className="d-block w-100"
            src="https://static1.thegamerimages.com/wordpress/wp-content/uploads/2020/01/Witcher-3-Splash.jpg"
            alt="Fourth slide"
          />
          <Carousel.Caption>
            <h3>The Witcher 3: Wild Hunt</h3>
            <p>
              Employ magic and superhuman skills to forge your own path in The
              Witcher 3: Wild Hunt.
            </p>
          </Carousel.Caption>
        </Carousel.Item>
              ...
              <section className="upcomingGamesList">
                <div className="pokemon" id="gameGrid">
                  ...
                  <div className="description">
                    {" "}
                    Seek out and take in-game photographs of Pokémon in their
                    native environments as you research Pokémon alongside
                    Professor Mirror.
                  </div>
                </div>
                ...
                <div className="biomutant" id="gameGrid">
                  ...
                  <div className="description">
                    {" "}
                    A post-apocalyptic Wung-Fu fable with unique martial art
                    styled combat system allowing you to mix melee, shooting,
                    and mutant ability action.{" "}
                  </div>
                </div>
                ...
                <div className="deathloop" id="gameGrid">
                  ...
                  <div className="description">
                    {" "}
                    Play Colt as you search for a way to put an end to a
                    timeloop trapping Blackreef while being hunted by the
                ...
                <div className="returnal" id="gameGrid">
                  ...
                  <div className="description">
                    {" "}
                    Play Selene (Anne Beyer), a space pilot armed with high-tech
                    weapons, stranded on the alien planet Atropos, and stuck in
                    a time loop.{" "}
                  </div>
                </div>
                ...
                <div className="balan" id="gameGrid">
                  <img
                    className="image"
                    src="https://www.gamereactor.eu/media/59/_3185983b.png"
                  />
                  <div className="title"> Solar Ash </div>
                  <div> Coming 2021 </div>
                  <div className="description">
                    {" "}
                    Find a vivid and highly stylized world filled with wild
                    high-speed traversal, endearing characters, and massive
                    enemy encounters.{" "}
                  </div>
                </div>
                ...
                <div className="farcry" id="gameGrid">
                  <img
                    className="image"
                    src="https://cdn.mos.cms.futurecdn.net/NGRzCGaYuRd6vVWM7Na43A.jpg"
                  />
                  <div className="title"> Far Cry 6 </div>
                  <div> Coming Mid 2021 </div>
                  <div className="description">
                    {" "}
                    As dictator of Yara, Antón Castillo is intent on restoring
                    his nation back to its former glory by any means, with his
                    son, Diego, dutifully at his side.{" "}
                  </div>
                </div>
              </section>
            </div>
